...
if ($display==0)
{
        #--------------------------------------------------#
        #
        #affiche les jobs par horaire d'exéon
        #
        #--------------------------------------------------#
        my $DOUBLON_JOB=" ";
        my $DOUBLON_STATUS=" ";
        ...
        foreach my $i (0..$#SQL)
        {
                ...
                $JOB=~ s/(^[ \s]+)|([ \s]+$)//g; #delete des espaces déet fin de ligne
                $STATUS=~ s/(^[ \s]+)|([ \s]+$)//g; #delete des espaces déet fin de ligne
                $STARTIME=~ s/(^[ \s]+)|([ \s]+$)//g; #delete des espaces déet fin de ligne
                $ENDTIME=~ s/(^[ \s]+)|([ \s]+$)//g; #delete des espaces déet fin de ligne
                $COMMAND=~ s/(^[ \s]+)|([ \s]+$)//g; #delete des espaces déet fin de ligne
                $PROFILE=~ s/(^[ \s]+)|([ \s]+$)//g; #delete des espaces déet fin de ligne
                $OWNER=~ s/(^[ \s]+)|([ \s]+$)//g; #delete des espaces déet fin de ligne
                $RUN_MACHINE=~ s/(^[ \s]+)|([ \s]+$)//g; #delete des espaces déet fin de ligne
                $EXIT_CODE=~ s/(^[ \s]+)|([ \s]+$)//g; #delete des espaces déet fin de ligne
                $RUNTIME=~ s/(^[ \s]+)|([ \s]+$)//g; #delete des espaces déet fin de ligne
                $HAS_OVERRIDE=~ s/(^[ \s]+)|([ \s]+$)//g; #delete des espaces déet fin de ligne
                $RUN_NUM=~ s/(^[ \s]+)|([ \s]+$)//g; #delete des espaces déet fin de ligne
                $NTRY=~ s/(^[ \s]+)|([ \s]+$)//g; #delete des espaces déet fin de ligne
                $DESCRIPTION=~ s/(^[ \s]+)|([ \s]+$)//g; #delete des espaces déet fin de ligne
                $EVENTSTATUS=~ s/(^[ \s]+)|([ \s]+$)//g; #delete des espaces déet fin de ligne
                $EVENTTXT=~ s/(^[ \s]+)|([ \s]+$)//g; #delete des espaces déet fin de ligne
                $EVENTTEXT=~ s/(^[ \s]+)|([ \s]+$)//g; #delete des espaces déet fin de ligne
                $EVENTSTAMP=~ s/(^[ \s]+)|([ \s]+$)//g; #delete des espaces déet fin de ligne
                $EVENTNUM=~ s/(^[ \s]+)|([ \s]+$)//g; #delete des espaces déet fin de ligne
                $MODIF=~ s/(^[ \s]+)|([ \s]+$)//g; #delete des espaces déet fin de ligne
                $INS=~ s/(^[ \s]+)|([ \s]+$)//g; #delete des espaces déet fin de ligne
...
#                       printf("%-1s;%-1s;%-1s;%1s;%-1s;%-1s;%1s;%1s;%-1s;%-1s;%+1s;\n",$JOB,$STATUS,$OVERRIDE,$EXIT_CODE,$SDATE,$EDATE,$RUNTIME,$ntry,$RUN_MACHINE,$INS,$MODIF);
                        printf("%-1s;%-1s;%-1s;%1s;%-1s;%-1s;%1s;%1s;%-1s;%-1s;%+1s;\n",$JOB,$EXIT_CODE,$SDATE,$EDATE,$RUN_MACHINE,$STATUS,$OVERRIDE,$RUNTIME,$ntry,$INS,$MODIF);
...
autosys_reporting_job.pl - Affiche le reporting de l'exéon des jobs.
...
autosys_reporting_job.pl [options] <job_name>
 ...
 Options:
   ...
   -f|F             date et heure de dé(au format YYYY/MM/DD hh:mm)
...
Type d'affichage
        ...
        0 : affiche les jobs par horaire d'exéon
        1 : affiche de exéon des jobs par groupe de job (box)
        2 : affiche de l'exéon des jobs

=item B<-f|F>

Date et heure de dé(au format YYYY/MM/DD hh:mm:ss)
...
B<autosys_reporting_job.pl> Affiche le reporting de l'exéon des jobs.
