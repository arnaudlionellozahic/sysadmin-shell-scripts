...
{
dsmc ar "${rep_appli}/${fic1}" -optfile=/opt/tivoli/tsm/client/ba/bin/AR/SLQDL7BDD01_AR-dsm.opt
}
...
{
dsmc ar "${rep_appli}/${fic2}" -optfile=/opt/tivoli/tsm/client/ba/bin/AR/SLQDL7BDD01_AR-dsm.opt 
}
...
{
dsmc q ar "${rep_appli}/${fic1}" -optfile=/opt/tivoli/tsm/client/ba/bin/AR/SLQDL7BDD01_AR-dsm.opt 
}
...
{
dsmc q ar "${rep_appli}/${fic2}" -optfile=/opt/tivoli/tsm/client/ba/bin/AR/SLQDL7BDD01_AR-dsm.opt
}
...
then
        ...
        mailx -r mbx-tip-app-bfi-rri@natixis.com -s "[${ENVI}][SVN] - La sauvegarde full du repertoire ${rep1a} est KO le ${J_DAY}" ld-tip-app-bgc-rri@natixis.com < ${out}
        exit 1
        ...
        then
                ...
                mailx -r mbx-tip-app-bfi-rri@natixis.com -s "[${ENVI}][SVN] - La sauvegarde full du repertoire ${rep2a} est KO le ${J_DAY}" ld-tip-app-bgc-rri@natixis.com < ${out}
                exit 1
else
	...
	cat ${out3} | grep svn | grep "$date" | awk -F " " '{printf "%+10s %+25s %+25s %+55s\n", $1, $3, $4, $5}' >> ${out} 
        mailx -r mbx-tip-app-bfi-rri@natixis.com -s "[${ENVI}][SVN] - Log de la sauvegarde full du ${J_DAY}" ld-tip-app-bgc-rri@natixis.com < ${out}
fi
}
...
out1=${rep_appli}/QDL7_DDUMP_SVN_RRI/logs/tsm_ar.log
out2=${rep_appli}/QDL7_DDUMP_SVN_RRI/logs/tsm_q_ar.log
out3=${rep_appli}/QDL7_DDUMP_SVN_RRI/logs/tsm_q_ar_tmp.log
J_DAY=$(date "+%Y%m%d")
date=$(date "+%m/%d/%Y")
ENVI=PREX
...
tsm_ar_svn > ${out1}_${J_DAY}
echo "" >> ${out1}_${J_DAY}
echo "---------------------------" >> ${out1}_${J_DAY}
echo "" >> ${out1}_${J_DAY}
tsm_ar_svn_rri >> ${out1}_${J_DAY}

tsm_q_ar_svn > ${out2}_${J_DAY}
echo "" >> ${out2}_${J_DAY}
echo "---------------------------" >> ${out2}_${J_DAY}
echo "" >> ${out2}_${J_DAY}
tsm_q_ar_svn_rri >> ${out2}_${J_DAY}
