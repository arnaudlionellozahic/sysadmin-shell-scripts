...
#export SAUVE_TEMP="/ficsav/EQUIPE_MEO/fred/Rapport_job_temp"
export SAUVE_TEMP="/apps/meoatlas2/rapport/Rapport_job_temp"
export SAUVE="/apps/meoatlas2/rapport/Rapport_job_${DATEJOB}"
export AUTOSERV=QI1
. /etc/auto.profile

#Lancement du script perl qui check tous le jobs en cours, running ou failure

/apps/meoatlas2/arnaud/autosys5.pl -j % -f "$DATEVEILLE 06:00:00" -t "$DATE 08:59:59" |tee $SAUVE_TEMP #>$FILE
...
#/usr/sbin/sendmail -f meo_atlas_paris -v frederic.gasnier@bnpparibas.com yuthay.yean@bnpparibas.com meo_atlas_paris <$FILE
