...
# on cherche d'abord dans cdi si la sysout existe, sinon on cherche dans cdi-0
...
To: mohamed.lalaoui-hassani@bnpparibas.com jean-noel.hontarrede@bnpparibas.com
