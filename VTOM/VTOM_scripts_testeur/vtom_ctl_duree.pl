...
$FICCTL="/home4/plair/scripts/vtom_ctl_duree.dta";
$FICSML="/home4/plair/scripts/vtom_ctl_duree.sml";
...
#print $duree_max;
   ...
   system("tlist ENCOURS|grep \"$environnement\"|grep \"$application\"|grep \"$traitement\">>/home4/plair/sisteron2/trace.txt");
   $status=0;
   if ("$status" == 0)
   {
