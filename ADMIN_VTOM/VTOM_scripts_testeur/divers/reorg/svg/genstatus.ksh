...
echo "- export global : (v)texport > referentiel_vtom.exp"
...
echo "  Syntaxe: "
echo "       pour 1 environnement : genstatus.ksh <Nom_d_environnement> "
echo "       pour 1 application   : genstatus.ksh <Nom_d_environnement> <Nom_d_application> "
echo
...
echo
echo "Environnement $1 inexistant => SORTIE."
echo
exit 1
}
echo
...
echo
echo "Application $1/$2 inexistante => SORTIE."
echo
exit 1
}
echo
...
echo "echo ---------------------" 
echo "echo" 
echo 'echo "Voulez vous consultez la log majstatus.log ? (Entrer ou Ctrl+c)"' 
echo "read a" 
