...
<body>
<div id="vtom"><h1 style="text-align:center;">ERREURS VTOM</h1></div>
</body>
</html> '

print "\n <p><B> Statistiques extraites le $(date +'%d/%m/%Y a %H:%M') </B><br /> \n"
}
...
print "<p><B><u><i> Valeur de date d'exploit $ENV :</i></u> `tgetdate -name=$ENV` </B><br /> \n"
echo "</p>"
}
...
echo '<html>
  ...
  #logo_bas {
    color:blue;
    background:url("file:///D:/Exploit_Absyss/VMWare_2/www/logo_absyss.png") no-repeat center top ;
        width: 250px;
    height: 120px;
        }
  </style>
...
# Main
cd /home/alozahic/Linux/centos63/Ver551d/sgbd/bin/
ENV=SOUMISSION
