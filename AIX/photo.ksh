...
=====================================
"
cft=`cat /apps/cft/fildat/cftinq.cfg |grep -i version | awk -F"=" '{print $2}'`
echo "The version of CFT is `printf "$(echo $cft | cut -c1)"."$(echo $cft | cut -c2)"."$(echo $cft | cut -c3)\n"`"
echo ""

echo "Subject: Photo_Serveur_${HOST}_${DATE}" | cat - Photo_${HOST}_${DATE} | sendmail.image -v -f paris_ips_meo_irb -t arnaud.lozahic@externe.bnpparibas.com
...
#(echo "Subject: Photo_Serveur_${HOST}_${DATE}"; echo; uuencode ${TRACE} ${TRACE}.txt)|sendmail.image -v -f paris_ips_meo_irb -t arnaud.lozahic@externe.bnpparibas.com,fathi.beddiar@bnpparibas.com,AFRIQUE_DSI_RA_VALMEP@bnpparibas.com,paris_ips_meo_irb@bnpparibas.com,francois.burnouf@bnpparibas.com,yuthay.yean@bnpparibas.com,benjamin.kalfon@bnpparibas.com
(echo "Subject: Photo_Serveur_${HOST}_${DATE}"; echo; uuencode ${TRACE} ${TRACE}.txt)|sendmail.image -v -f paris_ips_meo_irb -t arnaud.lozahic@externe.bnpparibas.com
#(echo "Subject: Photo_Serveur_${HOST}_${DATE}"; echo; uuencode ${TRACE} ${TRACE}.txt)|sendmail -v -f paris_ips_meo_irb -t arnaud.lozahic@externe.bnpparibas.com,fathi.beddiar@bnpparibas.com,AFRIQUE_DSI_RA_VALMEP@bnpparibas.com,paris_ips_meo_irb@bnpparibas.com,francois.burnouf@bnpparibas.com,yuthay.yean@bnpparibas.com,benjamin.kalfon@bnpparibas.com
